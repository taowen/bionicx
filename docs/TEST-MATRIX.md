...
| office | real WPS ARM64 | Writer, Sheets, Presentation, PDF import/export, clipboard | Writer durable copy/paste and cold reopen pass; Spreadsheets creates/calculates/saves/cold-reopens valid OOXML; Presentation launches untraced and creates a genuine editable title slide, with PPTX persistence/slideshow and PDF still pending |
