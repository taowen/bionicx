...
| office | real WPS ARM64 | Writer, Sheets, Presentation, PDF import/export, clipboard | Writer opens/creates a document, Qt compiles the XKB keymap/state, and Android-injected text enters the document; modifier fidelity (currently all-caps and unshifted punctuation), save/reopen, and other workflows remain |
