...
| office | real WPS ARM64 | Writer, Sheets, Presentation, PDF import/export, clipboard | Writer creates and saves a valid DOCX, performs an in-editor copy/paste through its real selection owner, survives a cold BionicX restart, reopens through its native file dialog, and preserves four exact paragraphs plus bold runs; remaining suites pending |
