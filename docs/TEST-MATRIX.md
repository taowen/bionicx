...
| X11 desktop | `x11-desktop-probe` | Render, XFixes, RandR resources/primary, XInput2, XKB map/event selection/device metadata; optional SHM | 5/5 passing; MIT-SHM deliberately unavailable pending safe backend |
...
| office | real WPS ARM64 | Writer, Sheets, Presentation, PDF import/export, clipboard | Writer main UI renders; previous primary-output/XKB warnings are gone; XKB names and interactive workflows remain |
