...
| X11 desktop | `x11-desktop-probe` | Render, XFixes, RandR, XInput2, XKB; optional SHM capability | 3/5 passing: Render, XFixes Region, coherent RandR single-screen topology |
