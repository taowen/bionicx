...
| office | real WPS ARM64 | Writer, Sheets, Presentation, PDF import/export, clipboard | Writer opens/creates a document; xkbcommon compilation blocks text input; save/reopen and other workflows remain |
