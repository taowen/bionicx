...
reopens it. D-Bus and CUPS are requested through `hostServices`.
PulseAudio and Vulkan stay on the later audio/GPU gates. The session
binary is the only app-private payload; libraries stay in the shared
rootfs.
