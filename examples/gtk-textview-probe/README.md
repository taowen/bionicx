...
empty light editor. The TEXT child pixmap is dumped (`tv-textwin`,
`tv-clear`) because a compositor presents that child. This is the text
widget path without a desktop session. Does not start a window manager.
