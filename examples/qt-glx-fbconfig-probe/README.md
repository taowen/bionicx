...
context. KeePassXC's first format is 2.0 / NoProfile / SingleBuffer with
depth/alpha/stencil omitted. This probe is a Gladio `libGL` client on the
shared seed, the same host GL path as those apps, not Debian mesa.
