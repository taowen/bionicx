...
a click at the dock still reaches the dock client. A Composite overlay
with empty Bounding and Input shapes is a hole: after the same restack
a click still reaches the dock, not the overlay.
