...
grep -F 'ControlMask' \
    "$repo_dir/examples/xi-x11-probe/xi-x11-probe.c" >/dev/null
grep -F 'sendXiKeyEvent(XInputExtension.XI_KEY_PRESS, keycode, focusedWindow)' \
    "$repo_dir/android/app/src/main/java/com/winlator/xserver/InputDeviceManager.java" >/dev/null
