...
static const char* globalImplementedDeviceExtensions[] = {"VK_KHR_swapchain", "VK_KHR_descriptor_update_template", "VK_EXT_private_data", "VK_EXT_memory_budget", "VK_EXT_map_memory_placed", "VK_KHR_map_memory2", "VK_EXT_transform_feedback", "VK_EXT_provoking_vertex"};
static const char* globalEmulatedDeviceExtensions[] = {"VK_KHR_timeline_semaphore"};
...
extern void retainSupportedDeviceExtensions(VkPhysicalDevice physicalDevice, char*** extensions, uint32_t* extensionCount);
extern void dropTimelineFromCreateInfo(VkDeviceCreateInfo* createInfo);
